...
import LogoFlock from '../src/assets/svg/logo-flock-tech.png';
            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    ...
                    <div className=" flex space-x-3 items-center">
                       <Image src={LogoFlock} width={50} height={50}></Image>
                        <h1 className=" font-normal text-2xl leading-6 text-gray-800">Flock Tech</h1>
                    </div>
