...
const Footer1 = () => {
    ...
    function sendEmail(e) {
        ...
        emailjs.send("service_oy249fj", "template_lesu6k3", templateParams, "KkYP2mgMlSka3nbC8").then((response) => {
    ...
    return (
        <div className="bg-white-800 px-4 py-9 md:px-6 md:py-12 lg:px-20 lg:py-12">
            ...
            <div class="lg:w-1/2 lg:mx-6">
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-black-500">
                            Av. Miguel Sutil, 6274 - Consil, Cuiabá - MT, 78048-000
                        </span>
                    </p>
               ...
               <div class="flex mt-4 -mx-1.5 ">
                    <div>
                        <Link href='https://web.facebook.com/flockmarketingeventos/?_rdc=10&_rdr'>
                             <span class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="#">
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    ...
                    <form class="mt-6" onSubmit={sendEmail}>
                        <div class="flex-1">
                            <label class="block mb-2 text-sm text-gray-600 light:text-gray-200">Nome:</label>
                            <input type="text" placeholder="Nome" class="block w-full px-5 py-3 mt-2 text-black-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 light:bg-gray-900 dark:text-black-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" onChange={(e) => setName(e.target.value)} value={name} />
                        </div>

                        <div class="flex-1 mt-6">
                            <label class="block mb-2 text-sm text-gray-600 light:text-gray-200">E-mail:</label>
                            <input type="email" placeholder="Endereço de e-mail..." class="block w-full px-5 py-3 mt-2 text-black-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 light:bg-gray-900 dark:text-black-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" onChange={(e) => setEmail(e.target.value)} value={email} />
                        </div>
